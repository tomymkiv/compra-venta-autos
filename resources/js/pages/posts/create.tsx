...
export default function create({ carBrands }: CreateProps) {
    ...
    return <>
        <form action="" onSubmit={handleSubmit} className="flex flex-col items-center justify-center gap-4 my-5 mx-3">
