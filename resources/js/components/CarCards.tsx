...
export default function CarCards({ post, src }: CarCardsProps) {
    return <>
        <Link href={src} className={`flex flex-col justify-around bg-[#222] shadow-sm transition-shadow duration-200 hover:shadow-blue-400 min-h-[550px] text-gray-200 p-3.5 rounded-xl gap-0.5 my-3.5 md:my-0 min-w-[350px] md:min-w-auto`} title="Ver vehiculo">
            ...
            <div className="mb-6 mt-2 space-y-1.5">
                ...
                <h6 className="font-semibold">Ubicación: {post.ubicacion}</h6>
            </div>
