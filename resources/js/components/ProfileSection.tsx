                ...
                <>
                    <div className="w-fit flex flex-col items-center gap-5 p-2 rounded-md">
                        <div className="flex items-center">
                            <img src={loguedUser.avatar?.includes('api') ? loguedUser.avatar : `/storage/${loguedUser.avatar}`} className="rounded-full object-cover w-80 h-80" alt={"Imagen del usuario"} />
                        </div>
